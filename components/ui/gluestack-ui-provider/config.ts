...
export const config = {
  light: vars({
    /*Couleur fc */
    '--color-fc_primary': '21 95 220',
    '--color-fc_secondary': '77 23 154',
    '--color-fc_tertiary': '152 16 250',
    '--color-fc_neutral': '50 128 255',
    '--color-fc_variant': '94 143 255',
    '--color-fc_error': '251 44 54',
    '--color-fc_success': '5 223 114',
    '--color-fc_gold': '255 215 0',
    '--color-fc_darelle': '21 95 220',
  ...
  dark: vars({
    /**Fc colors dark mode */
    '--color-fc_primary': '21 95 220',      // Bleu plus clair (#60A5FA)
    '--color-fc_secondary': '77 23 154',   // Violet plus clair (#A78BFA)
    '--color-fc_tertiary': '192 132 252',    // Violet pastel (#C084FC)
    '--color-fc_neutral': '50 128 255',     // Gris bleuté (#94A3B8)
    '--color-fc_variant': '94 143 255',     // Bleu très clair (#93C5FD)
    '--color-fc_error': '248 113 113',       // Rouge plus doux (#F87171)
    '--color-fc_success': '52 211 153',      // Vert plus doux (#34D399)
    '--color-fc_gold': '255 215 0',
    '--color-fc_darelle': '51 51 51',
