            ...
            <VStack space="4xl" className="my-10 w-full flex-1 h-full items-center">
                ...
                <VStack space="md" className=" w-full h-full mt-7 flex-1 items-center px-10">
                        ...
                        <HStack space="md" reversed={false} className="items-center justify-center w-full justify-between"> 
                            ...
                            <FontAwesome name="user" size={24} color="#155FDC" />
                        ...
                        <HStack space="md" reversed={false} className="items-center justify-center w-full justify-between"> 
                            <HStack space="md" className="items-center">
                            <Ionicons name="mail" size={20} color="#155FDC" />
                        ...
                        <HStack space="md" reversed={false} className=" justify-center items-center w-full justify-between "> 
                            <HStack space="md" className="items-center">
                            <Ionicons name="call" size={20} color="#155FDC" />
                            <Text size="lg" bold>Mobile</Text>
                            </HStack>
                            <Text className="text-typography-500 text-sm opacity-80 ml-6">{isLoggedIn?user.number:"6 XX XX XX XX"}</Text>
                        </HStack> 
                        ...
                        <HStack space="md" reversed={false} className=" justify-center items-center w-full justify-between "> 
                            <HStack space="md" className="items-center">
                            <FontAwesome5 name="history" size={20} color="#155FDC" />
                    ...
                    <VStack space="sm" className="p-4 mt-5 ">
                        <Button variant="link" action="primary" onPress={handleLogin} size="lg">
                            <Ionicons name="log-in-outline" size={20} color="#155FDC" />
                        ...
                        <Button variant="solid" onPress={handleSignup} className="bg-white shadow-sm" >
                            <Ionicons name="person-add-outline" size={20} color={!isDark?"#9810FA":"#C084FC"} />
                            <ButtonText className="ml-1 text-fc-tertiary">{t('ins_inscription')}</ButtonText>
                        </Button>
                    </VStack>
                     )}
                </VStack>
